...
- Middle section: a 3-column layout — nav links column, contact details column (address, phone, email from constants/site.ts), and a short studio description column
- Bottom row: copyright line left ("© [current year] Creative Studio. All rights reserved."), "Designed & developed in Ahmedabad" right — use JS Date to generate the year dynamically, never hardcode it
